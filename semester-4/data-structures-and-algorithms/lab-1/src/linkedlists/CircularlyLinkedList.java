...
public class CircularlyLinkedList<E> implements Cloneable {
  ...
  public String toString() {
    ...
    public CircularlyLinkedList<E> clone() throws CloneNotSupportedException {
        ...
        Node<E> origHead = tail.getNext();

        // Create new head node
        Node<E> otherHead = new Node<>(origHead.getElement(), null);
        Node<E> otherPrev = otherHead;

        // Copy remaining nodes until we loop back
        Node<E> walk = origHead.getNext();
        while (walk != origHead) {
        ...
        // Close the circle and set tail
        otherPrev.setNext(otherHead);
        other.tail = otherPrev;
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            System.out.println("\nRemove first");
            System.out.println("Move first to back");
