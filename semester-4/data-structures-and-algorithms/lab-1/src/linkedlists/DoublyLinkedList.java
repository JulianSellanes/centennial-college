...
public class DoublyLinkedList<E> {
  ...
  public String toString() {
    ...
    public void concatenate(DoublyLinkedList<E> other) {
        ...
        // First and last real nodes of 'other'
        Node<E> firstOther = other.header.getNext();
        Node<E> lastOther  = other.trailer.getPrev();

        if (this.isEmpty()) {
            // Splice other's chain between this header and trailer
            header.setNext(firstOther);
            firstOther.setPrev(header);

            lastOther.setNext(trailer);
            trailer.setPrev(lastOther);
        } else {
            Node<E> lastThis = trailer.getPrev();
        ...
        // Make 'other' empty again (restore its sentinels)
